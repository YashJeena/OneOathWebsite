...
<html lang="en">
  <head>
    ...
    <title>One Oath: Student DashBoard</title>
...
<div class="cardbox">
  ...
  <div class="col-sm-6 mb-3 mb-sm-0 ">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">PAT</h5>
        <p class="card-text">Customized assessment test tailored for individual strengths and weaknesses.</p>
        <a href="https://oneoath.wixsite.com/one-oath/team-3" class="btn btn-primary">Take Test</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6" >
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">Comprehensive student report highlighting academic progress and areas for improvement.</p>
        <a href="studentreport.php" class="btn btn-primary">Report</a>
      </div>
    </div>
  </div>
</div>
