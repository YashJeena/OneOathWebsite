...
<html lang="en">
  <head>
    ...
    <title>One Oath: Teacher DashBoaard</title>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="teacherdashboard.php">DashBoard</a>
              </li>
              <li class="nav-item">
...
<div class="cardbox">
  ...
  <div class="col-sm-6 mb-3 mb-sm-0 ">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">CREATE PAT</h5>
        <p class="card-text"> Cerate Customized assessment test tailored for individual strengths and weaknesses.</p>
        <a href="https://workspace.google.com/intl/en_in/lp/forms/?utm_source=bing&utm_medium=cpc&utm_campaign=1605214-Workspace-APAC-IN-en-BKWS-PHR-LV&utm_content=text-ad-none-none-DEV_c-CRE_-ADGP_Hybrid%20%7C%20BKWS%20-%20PHR%20%7C%20Txt_Forms_1-KWID_43700075286209491-kwd-77997012579757:loc-90&userloc_158324-network_o=&utm_term=KW_make%20google%20forms&gclid=6f478ecdc6751eadfe25ea75d329247c&gclsrc=3p.ds" class="btn btn-primary">Create Test</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6" >
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">Comprehensive user profile highlighting academic user details as a teacher.</p>
        <a href="teacherprofile.php" class="btn btn-primary">Profile</a>
      </div>
    </div>
  </div>
</div>
